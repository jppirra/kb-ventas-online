  ...
  return (
    <div className={`relative group ${className}`} style={{ aspectRatio }}>
      ...
      <button
        ...
        disabled={uploading}
        className="absolute inset-0 flex items-center justify-center rounded-xl bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity disabled:cursor-wait"
      >
        {uploading ? (
