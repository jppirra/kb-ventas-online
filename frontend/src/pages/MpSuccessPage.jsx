...
export default function MpSuccessPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 flex flex-col items-center justify-center px-4 py-16">
      ...
      {/* CTA Mercato */}
      <div className="mt-8 max-w-md w-full bg-white rounded-3xl border border-blue-100 shadow-sm p-8 text-center space-y-4">
        ...
        <p className="text-sm text-gray-500 leading-relaxed">
          Publicá tu catálogo online, recibí pedidos y cobrá con Mercado Pago — todo desde un solo lugar.
          <span className="font-semibold text-gray-700"> Gratis, sin comisiones.</span>
        </p>
